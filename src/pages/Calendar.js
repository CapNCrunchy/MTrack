...
var events = [
    {
        start: new Date(moment().subtract(2, "days").set({ hour: 9, minute: 0 })),
        end: new Date(moment().subtract(2, "days").set({ hour: 10, minute: 0 })),
        title: "Ibuprofen 200mg",
    },
    {
        start: new Date(moment().subtract(2, "days").set({ hour: 14, minute: 0 })),
        end: new Date(moment().subtract(2, "days").set({ hour: 15, minute: 0 })),
        title: "Gabapentin 300mg",
    },
    {
        start: new Date(moment().subtract(1, "days").set({ hour: 9, minute: 0 })),
        end: new Date(moment().subtract(1, "days").set({ hour: 10, minute: 0 })),
        title: "Lisinopril 10mg",
    },
    {
        start: new Date(moment().subtract(1, "days").set({ hour: 14, minute: 0 })),
        end: new Date(moment().subtract(1, "days").set({ hour: 15, minute: 0 })),
...
function CalendarView() {
    return (
        <div>
            <button onClick={() => { window.location.href = '/dashboard'; }} className='mb-6 flex h-fit items-center gap-2 bg-indigo-700 text-white p-2 rounded-lg hover:bg-indigo-600 active:bg-indigo-700'>
                <CaretLeft size={20} />
                Dashboard
            </button>
