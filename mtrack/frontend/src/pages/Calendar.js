...
function CalendarView() {
    return (
        <div>
            <Link to={"/dashboard"} className='mb-6 flex h-fit w-fit items-center gap-2 bg-indigo-700 text-white p-2 pr-4 rounded-lg hover:bg-indigo-600 active:bg-indigo-700'>
                <CaretLeft size={20} />
                Dashboard
            </Link>
